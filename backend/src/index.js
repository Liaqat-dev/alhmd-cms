...
const morningFeeRoutes = require('./routes/morningFees');
const marksRoutes = require('./routes/marks');
const reportRoutes = require('./routes/reports');
const morningSalaryRoutes = require('./routes/morningSalaries');
...
app.use('/api/morning-fees', morningFeeRoutes);
app.use('/api/marks', marksRoutes);
app.use('/api/reports', reportRoutes);
app.use('/api/morning-salaries', morningSalaryRoutes);
