...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-base font-semibold leading-tight tracking-tight text-gray-800 dark:text-dark-100",
      className
    )}
    {...props}
  />
...
const CardDescription = React.forwardRef(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-gray-400 dark:text-dark-500 mt-0.5", className)}
    {...props}
  />
))
